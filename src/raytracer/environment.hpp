...
public:
  ...
  virtual int intersect(const IntegratorData &id, const SurfacePoint &surfacepoint, RayHit &hit) = 0;
...
public:
  ...
  int intersect(const IntegratorData &id, const SurfacePoint &surfacepoint, RayHit &hit) override;
private:
  QuadTree *tree;
  Real checkr;
};
